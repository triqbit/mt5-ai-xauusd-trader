...
- **8-Layer Risk Cascade:** Institutional validation using Drawdown, Daily Loss Limits, Activity Limits, Exposure Limits, Symbol Allocation, Confidence, Risk-Reward, and Model Health.
