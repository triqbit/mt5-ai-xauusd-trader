...
- **11-Layer Execution Filter:** Cascade validation using ATR, Trend Angle, Momentum, EMA sequencing, Session time, Drawdown, Model Stability, Performance, Confidence, Signal Consistency, and Macro Risk.
