...
### Added
- **Enterprise Trade Logging:** Persistent trade, signal, metric, and risk event logging with institutional performance analytics (Sharpe, Profit Factor, MDD) and SQLAlchemy 2.0 integration in `src/core/trade_logger.py`.
