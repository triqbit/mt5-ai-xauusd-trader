...
### Added
- **Hardened Database Schema:** Implemented SQL-level `CheckConstraint`s and optimized composite indexes for `TradeLogger` models in `src/core/trade_logger.py` to ensure data integrity and query performance.
