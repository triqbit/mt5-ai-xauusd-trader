...
### 4. Diversification-aware Routing
The `route_allocation` method evaluates multiple eligible strategies for a given symbol and selects the one that results in the best overall portfolio diversification (measured using the Herfindahl-Hirschman Index - HHI).

### 5. Linear Soft-Scaling
