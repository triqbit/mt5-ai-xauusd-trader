...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `9303d28a55dcfdcd28aef52ff3f8ddebd44edeae`
...
- **Domains touched**: dependencies
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `9303d28a55dcfdcd28aef52ff3f8ddebd44edeae`, tests, docs
- **Recommendation**: Needs CI success before merge
