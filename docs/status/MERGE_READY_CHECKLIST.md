...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `14ec21bf54558a271beed540ed2351ac3ffc5ac7`
...
- **Domains touched**: dependencies
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `14ec21bf54558a271beed540ed2351ac3ffc5ac7`, tests, docs
- **Recommendation**: Needs CI success before merge
