...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `8c8ed2781f55a1ca88b6220cf523fc4b078c6045`
...
- **Domains touched**: dependencies
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `8c8ed2781f55a1ca88b6220cf523fc4b078c6045`, tests, docs
- **Recommendation**: Needs CI success before merge
