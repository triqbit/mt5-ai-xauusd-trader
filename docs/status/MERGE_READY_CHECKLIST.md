...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `24d45e6006d5a41bd7acd608dbfd3a2353e5915a`
...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `24d45e6006d5a41bd7acd608dbfd3a2353e5915a`, tests, docs
- **Recommendation**: Needs CI success before merge
