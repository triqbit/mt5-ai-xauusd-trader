...
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `5fa2c89152102db7b092f5006454e707959e6182`
...
- **Domains touched**: dependencies
- **CI status**: pending
- **Missing items**: Mandatory rebase against commit `5fa2c89152102db7b092f5006454e707959e6182`, tests, docs
- **Recommendation**: Needs CI success before merge
