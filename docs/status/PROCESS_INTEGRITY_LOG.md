...
- **Persistent Global CI Blockage:** CI remains hard-blocked by repository-wide formatting drift (122 files identified June 29). Merges continue to bypass all safety gates.
