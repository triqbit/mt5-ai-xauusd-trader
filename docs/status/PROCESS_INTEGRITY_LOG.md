...
- **Persistent Global CI Blockage:** CI remains hard-blocked by 122 formatting errors across the repository and 6 linting errors in `migrations/env.py`. Jules06 cannot unblock CI as formatting many of these files (e.g. in `src/trading/`) violates lane boundaries.
