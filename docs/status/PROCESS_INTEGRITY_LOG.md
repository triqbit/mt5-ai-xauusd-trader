...
- **Persistent Global CI Blockage:** CI remains hard-blocked by 6 linting errors in `migrations/env.py` and 122 Ruff formatting violations across the repository. Merges continue to bypass all safety gates.
