...
- [ ] CI must pass before merge (**VIOLATED**: Merges continue while CI remains globally blocked. Note: Today's Integrity Report PR is also blocked by repository-wide formatting debt (120 files).).
