...
- **Extreme Labeling Drift (PR #1229):** Commit `f7f391a` is titled "Enhance Institutional Research Reporting System (#1229)", yet it replaces 499 files and ~435,011 lines of code. This continues the pattern of masking total system replacements (including core trading, risk, and infrastructure logic) under specific feature labels.
