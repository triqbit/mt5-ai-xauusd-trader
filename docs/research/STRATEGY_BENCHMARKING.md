...
The framework uses paired t-tests on return distributions to calculate **P-Values**, helping determine if a strategy's outperformance over a baseline is statistically significant.
