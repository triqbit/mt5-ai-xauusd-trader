...
def upgrade() -> None:
    ...
    with op.batch_alter_table("model_signals", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_model_signals_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_model_signals_is_deleted"), ["is_deleted"], unique=False
        )
    ...
    with op.batch_alter_table("performance_metrics", schema=None) as batch_op:
        ...
        batch_op.alter_column("is_deleted", existing_type=sa.BOOLEAN(), nullable=False)
        batch_op.create_index(
            batch_op.f("ix_performance_metrics_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_performance_metrics_is_deleted"), ["is_deleted"], unique=False
        )
    ...
    with op.batch_alter_table("trades", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("updated_by", sa.String(length=100), nullable=True))
        batch_op.add_column(sa.Column("deleted_at", sa.DateTime(), nullable=True))
        batch_op.alter_column("ticket", existing_type=sa.INTEGER(), nullable=False)
        batch_op.alter_column("pnl", existing_type=sa.FLOAT(), nullable=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("trades", schema=None) as batch_op:
        ...
        batch_op.alter_column("pnl", existing_type=sa.FLOAT(), nullable=True)
        batch_op.alter_column("ticket", existing_type=sa.INTEGER(), nullable=True)
