...
class RiskManager:
    ...
    def validate_signal(
        ...
        # Layer 5: Symbol Allocation (XAUUSD focus)
    ...
    def size_position(self, symbol: str, market_data: pd.DataFrame) -> float:
        ...
        # Approx 30 days of M5 (24h * 12 bars/h * 30 = 8640)
        avg_atr = market_data["atr"].tail(8640).mean()

        vol_multiplier = 1.0
        ratio = current_atr / avg_atr if (avg_atr and avg_atr > 0) else 1.0
    ...
    def update_equity(self, current_equity: float) -> None:
        """Update equity trackers and peak equity."""
    ...
    def record_pnl(self, pnl: float) -> None:
        """Accumulate intraday realised PnL and trade counts."""
    ...
    def _check_directional_exposure(
        ...
        # Gold price estimate for notional calculation
