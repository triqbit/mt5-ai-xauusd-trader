...
class AuditedRiskManager(RiskManager):
    ...
    def approve(
        ...
        Logs the full decision chain to the audit log using the trace from RiskDecision.
        """
        # Call parent approve to get the definitive RiskDecision and its audit trace
        ...
        try:
            ...
            # Log daily loss level 4 triggers specifically
