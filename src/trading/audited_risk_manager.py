...
class AuditedRiskManager(RiskManager):
    ...
    def approve(
        ...
        """
        Run the full 8-layer risk filter cascade with integrated audit logging.
        ...
        try:
            ...
            if not decision.trace.get("layer1_drawdown", True):
            ...
            if not decision.trace.get("layer2_daily_loss", True):
                audit.log_operator_action(
                    operator="system",
