...
All data packets generated by this system are immutable (frozen) to ensure
that the information presented to the operator remains consistent and
cannot be altered by subsequent processing steps.
