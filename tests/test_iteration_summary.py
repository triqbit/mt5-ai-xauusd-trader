...
class TestIterationSummary(unittest.TestCase):
    ...
    def test_monitor_new_methods(self):
        ...
        with patch('src.core.monitor.MARKET_STABILITY_GAUGE.set') as mock_stability, \
             patch('src.core.monitor.ITERATION_HEARTBEAT_GAUGE.set_to_current_time') as mock_heartbeat, \
    ...
    def test_send_message_with_trace_id(self):
        ...
        with patch('structlog.contextvars.get_contextvars', return_value={'trace_id': 'test-uuid-12345'}):
