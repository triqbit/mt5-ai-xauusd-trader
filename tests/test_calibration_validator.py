...
def test_calibration_threshold_validation_pass():
    ...
    config = TradingConfig(MT5_PASSWORD="test", MT5_SERVER="test", model_calibration_threshold=0.20)
...
def test_calibration_threshold_validation_critical():
    ...
    config = TradingConfig(MT5_PASSWORD="test", MT5_SERVER="test", model_calibration_threshold=0.30)
    validator = ConfigValidator(config)
    validator.validate()
