...
def setup_mock_talib(m_talib):
    ...
    m_talib.SMA.side_effect = lambda data, *a, **k: np.random.rand(len(data))
    m_talib.SUM.side_effect = lambda data, *a, **k: np.random.rand(len(data))
    m_talib.ROCP.side_effect = lambda data, *a, **k: np.random.rand(len(data))
