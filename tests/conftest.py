...
mock_talib.PLUS_DI.side_effect = lambda h, l, c, **kwargs: np.zeros(len(c))
mock_talib.MINUS_DI.side_effect = lambda h, l, c, **kwargs: np.zeros(len(c))
...
mock_talib.WILLR.side_effect = lambda h, l, c, **kwargs: np.zeros(len(c))
mock_talib.ULTOSC.side_effect = lambda h, l, c, **kwargs: np.zeros(len(c))
